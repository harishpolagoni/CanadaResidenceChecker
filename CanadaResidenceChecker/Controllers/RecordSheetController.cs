using CanadaResidenceChecker.DAL.Interface;
using CanadaResidenceChecker.Models;
using Microsoft.AspNetCore.Mvc;
using Newtonsoft.Json;

namespace CanadaResidenceChecker.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class RecordSheetController: ControllerBase
    {
        ...
        private string dbFilePath = "..\\CanadaResidenceChecker\\Db\\ResidenceRecord.json";
